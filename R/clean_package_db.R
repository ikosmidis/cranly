...
clean_up_author <- function(variable) {
    variable %>%
        ...
        str_replace_all("\\d{4}", "") %>%
        str_replace_all("R core team|R Core Development Team|R Core team|R Development Core Team|R core|R Core Deveopment Team|R development team|R-core|R-Core|the R Core Team|The R Core Team|The R Core Team -", "R Core") %>%
