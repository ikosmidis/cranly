...
Let's download, clean and organize today's CRAN database, and build the package directives network
```{r}
library("cranly")
package_db <- clean_CRAN_db()
package_network <- build_network(package_db, perspective = "package")
```
